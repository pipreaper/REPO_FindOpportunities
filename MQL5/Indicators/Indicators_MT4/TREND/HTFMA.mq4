...
int OnInit()
  {
   ...
   if(drawBegin>(bars-(fEMA+sEMA)-1))
      drawBegin=bars-(fEMA+sEMA)-1;
   if(drawBegin<=0)
      drawBegin=0;
   IndicatorBuffers(3);
   IndicatorShortName("HTFMA"+" "+instrument+" "+string(enumHTFPeriod));
...
//SetIndexArrow(2,234);
   SetIndexLabel(2,"MA Status");
   SetIndexBuffer(2,ExtStatus);
   SetIndexEmptyValue(2,EMPTY_VALUE);
   SetIndexDrawBegin(2,drawBegin);
