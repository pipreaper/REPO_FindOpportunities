...
//--- create a text label
   if(!ObjectCreate(chart_ID,name,OBJ_LABEL,sub_window,0,0))
     {
      Print(__FUNCTION__,
            ": failed to create text label! Error code: ",name,"_",ErrorDescription(GetLastError()));
      return(false);
     }
...
//--- delete the label
   if(!ObjectDelete(chart_ID,name))
     {
      Print(__FUNCTION__,
            ": failed to delete a text label! ",name," Error code = ",GetLastError());
      return(false);
     }
//--- successful execution
   return(true);
...
//+------------------------------------------------------------------+
bool MoveAndTextChange(string labelName, const int x,const int y,string text)
  {
//--- move the label
   if(!LabelMove(0,labelName,x,y))
      return(false);
//--- change the label text
   if(!LabelTextChange(0,labelName,text))
      return(false);
//--- redraw the chart
   ChartRedraw();
