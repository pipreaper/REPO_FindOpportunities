...
extern ENUM_TIMEFRAMES  waveHTFPeriod=PERIOD_CURRENT;//HHTF shown
...
extern bool             eShowTrendData=true;//show Trend Data
         ...
         if(varTrail=="UP")
           {
            ...
            tList.update(T[endIndex],tList.maxBar);
            tList.setTrend(continuationUp);
            tList.isCrediblePullBack(continuationUp,phtfShift);
            ExtTrend[endIndex]=tList.trend;
            ...
            setWaveStatus(oEndTime,endTime,"UP",H[endIndex],L[endIndex],ExtTrendPrice[endIndex],tList,clrLine,ExtVol[endIndex],tList.isCrediblePullBack(continuationUp,phtfShift));
         ...
         else if(varTrail=="DOWN")
           {
            ...
            tList.cycle(T[endIndex],tList.maxBar);
            tList.setTrend(reversalUp);
            ...
            oEndTime=endTime;
            oEndIndex=iBarShift(instrument,Period(),oEndTime,true);
            setWaveStatus(oEndTime,endTime,"UP",H[endIndex],L[endIndex],ExtTrendPrice[endIndex],tList,clrLine,ExtVol[endIndex],tList.isCrediblePullBack(reversalUp,phtfShift));
            //else if(eShowVolumesData)
            //   setVolumeText(oEndTime,endTime,"UP",H[endIndex],L[endIndex],ExtVol[endIndex],clrLine,showData);
            tList.maxBar=0;
            tList.minBar= INF;
         ...
         if(varTrail=="DOWN")
           {
            ...
            oEndTime=endTime;
            oEndIndex=iBarShift(instrument,Period(),oEndTime,true);
            setWaveStatus(oEndTime,endTime,"DOWN",H[endIndex],L[endIndex],ExtTrendPrice[endIndex],tList,clrLine,ExtVol[endIndex],tList.isCrediblePullBack(continuationDown,phtfShift));
            //else if(eShowVolumesData)
         ...
         else if(varTrail=="UP")
           {
            ...
            oEndTime=endTime;
            oEndIndex=iBarShift(instrument,Period(),oEndTime,true);
            setWaveStatus(oEndTime,endTime,"DOWN",H[endIndex],L[endIndex],ExtTrendPrice[endIndex],tList,clrLine,ExtVol[endIndex],tList.isCrediblePullBack(reversalDown,phtfShift));
            //else if(eShowVolumesData)
            //   setVolumeText(oEndTime,endTime,"DOWN",H[endIndex],L[endIndex],ExtVol[endIndex],clrLine,showData);
            tList.maxBar=0;
            tList.minBar= INF;
...
//| setWaveStatus                                                    |
//+------------------------------------------------------------------+  
void setWaveStatus(datetime oldTime,datetime newTime,string direction,double H,double L,double Tr,trendList &p,color indexColor,double waveVolume,bool isPullBack)
  {
   string data=NULL;
...
//  }
   ...
   if(eShowVolumesData && eShowTrendData && isPullBack && (tg != NULL))
   ...
   else if (eShowVolumesData && eShowTrendData && !isPullBack)
      ObjectSetText(sNewTime,"("+DoubleToStr(waveVolume,0)+")",fontSize,fontType,indexColor);   
